...
-- CreateIndex
CREATE UNIQUE INDEX "organization_members_user_id_organization_id_key" ON "public"."organization_members"("user_id", "organization_id");
...
-- AddForeignKey
ALTER TABLE "public"."member" ADD CONSTRAINT "member_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "public"."organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
